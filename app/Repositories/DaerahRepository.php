...
use App\Http\Resources\DaerahResource;
...
class DaerahRepository
{
    ...
    public function getListData()
    {
        try {
            ...
            $data = DaerahResource::collection(DaerahModel::get());
    ...
    public function getPostList($params)
    {
        try {
            ...
            if (strlen($kabupatenId) == 0) {
                ...
                $data = new DaerahModel();
            } else {
                // query untuk ubah data dengan find data
                $data = DaerahModel::find($kabupatenId);
